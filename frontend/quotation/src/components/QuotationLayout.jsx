          ...
          <div style={styles.termsViewer}>
            ...
            {quotationData.termsImage && (
              <div style={{ flex: '0 0 300px', maxWidth: '300px' }}>
                <div style={styles.termsImageContainer}>
                  <img src={quotationData.termsImage} alt="Terms" style={styles.termsImage} />
                </div>
                <p style={styles.termsImageCaption}>Reference Image</p>
              </div>
            )}
          </div>
        )}
